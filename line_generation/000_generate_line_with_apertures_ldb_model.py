...
env = xt.load_madx_lattice('acc_models/SPS_LS2_2025-03-05.seq')
env.vars.load_madx('acc_models/lhc_q20.str')
line = env.sps
...
endsequence;
''')
mad.call('acc_models/APERTURE_SPS_EYETS 2024-2025_05-MAR-2025.seq')
mad.beam()
mad.use('SPS')
